import { Category, CityDelivery, Product, ProductReview, ShopSettings } from '../types';
...
export const initialShopSettings: ShopSettings = {
  ...
  usdToIqdRate: 1500, // $1 = 1,500 IQD ($100 = 150,000 IQD)
  adminPin: '1254',
  masterRecoveryKey: 'SHWAN-9988',
  announcementKu: '🔥 داشکاندنی تایبەت بەبۆنەی کردنەوەی لقی ئۆنلاین بۆ هەموو شار و شارۆچکەکانی کوردستان!',
  showAnnouncement: true,
  freeDeliveryThresholdIqd: 100000,
...
export const kurdistanCities: CityDelivery[] = [
  { id: 'erbil', nameKu: 'هەولێر (هەموو گەڕەکەکان)', nameEn: 'Erbil', feeIqd: 3000, feeUsd: 2, estimateKu: '١ بۆ ٢٤ کاتژمێر' },
  { id: 'slemani', nameKu: 'سلێمانی (ناوشار و دەوروبەر)', nameEn: 'Sulaymaniyah', feeIqd: 4000, feeUsd: 2.7, estimateKu: '٢٤ بۆ ٤٨ کاتژمێر' },
  { id: 'duhok', nameKu: 'دهۆک و زاخۆ', nameEn: 'Duhok & Zakho', feeIqd: 4000, feeUsd: 2.7, estimateKu: '٢٤ بۆ ٤٨ کاتژمێر' },
  { id: 'kirkuk', nameKu: 'کەرکووک', nameEn: 'Kirkuk', feeIqd: 4000, feeUsd: 2.7, estimateKu: '٢٤ بۆ ٤٨ کاتژمێر' },
  { id: 'halabja', nameKu: 'هەڵەبجە و شارەزوور', nameEn: 'Halabja', feeIqd: 5000, feeUsd: 3.3, estimateKu: '٢٤ بۆ ٤٨ کاتژمێر' },
  { id: 'soran', nameKu: 'سۆران، چۆمان، ڕەواندز', nameEn: 'Soran & Rawanduz', feeIqd: 5000, feeUsd: 3.3, estimateKu: '٢٤ بۆ ٤٨ کاتژمێر' },
  { id: 'ranya', nameKu: 'ڕانیە و قەڵادزێ و پشدەر', nameEn: 'Ranya & Qaladze', feeIqd: 5000, feeUsd: 3.3, estimateKu: '٢٤ بۆ ٤٨ کاتژمێر' },
  { id: 'kalar', nameKu: 'کەلار و گەرمیان و کفری', nameEn: 'Kalar & Garmian', feeIqd: 5000, feeUsd: 3.3, estimateKu: '٢٤ بۆ ٤٨ کاتژمێر' },
  { id: 'akry', nameKu: 'ئاکرێ و بەردەڕەش و ئامێدی', nameEn: 'Akre & Amedi', feeIqd: 5000, feeUsd: 3.3, estimateKu: '٢٤ بۆ ٤٨ کاتژمێر' },
];
...
export const initialReviews: ProductReview[] = [
  {
    id: 'rev-1',
    productId: 'prod-1',
    customerName: 'ڕەوەند کاروان',
    cityKu: 'هەولێر',
    rating: 5,
    commentKu: 'دەستان خۆش بێت کاتژمێرەکە گەیشت، کوالیتیەکەی یەکجار بەرزە و زۆر لە وێنەکەش جوانترە. لە ماوەی کەمتر لە ۲۴ کاتژمێردا گەیاندیانە ماڵەوە.',
    createdAt: '٢ ڕۆژ پێش ئێستا',
    isVerifiedPurchase: true,
  },
  {
    id: 'rev-2',
    productId: 'prod-1',
    customerName: 'سۆران عەلی',
    cityKu: 'سلێمانی',
    rating: 5,
    commentKu: 'پاترییەکەی زۆر باشە، هەموو نۆتیفیکەیشنەکانی کوردی پیشان دەدات بێ هیچ کێشەیەک. مامەڵەی کاک شوان زۆر بەڕێزانە بوو.',
    createdAt: 'هەفتەیەک پێش ئێستا',
    isVerifiedPurchase: true,
  },
  {
    id: 'rev-3',
    productId: 'prod-2',
    customerName: 'دکتۆر ئاراس',
    cityKu: 'دهۆک',
    rating: 5,
    commentKu: 'بۆنێکی زۆر خۆش و هێمن، لە دەوام بەکاری دەهێنم و بۆنی بەردەوام دەمێنێتەوە. نرخەکەتان زۆر گونجاوە بەراورد بە بازاڕ.',
    createdAt: '٣ ڕۆژ پێش ئێستا',
    isVerifiedPurchase: true,
  },
  {
    id: 'rev-4',
    productId: 'prod-3',
    customerName: 'هێمن مەحموود',
    cityKu: 'کەرکووک',
    rating: 5,
    commentKu: 'دەنگی سپیکەرەکە زۆر بەرز و بێ خەوشە، بەسەرکەوتوویی لەگەڵ مۆبایلەکەم بەسترایەوە، زۆر سوپاس بۆ پێشەنگای شوان.',
    createdAt: '٥ ڕۆژ پێش ئێستا',
    isVerifiedPurchase: true,
  },
  {
    id: 'rev-5',
    productId: 'prod-4',
    customerName: 'شیلان غەفوور',
    cityKu: 'هەولێر',
    rating: 5,
    commentKu: 'ئێرفۆنێکی زۆر نایابە، کاتی تەلەفۆن کردن و مووزیک دەنگ زۆر سافە و گوێ ماندوو ناکات.',
    createdAt: '٤ ڕۆژ پێش ئێستا',
    isVerifiedPurchase: true,
  }
];
